...
var EmailType;
(function (EmailType) {
    EmailType["CommentReply"] = "CommentReply";
    EmailType["Contact"] = "Contact";
})(EmailType = exports.EmailType || (exports.EmailType = {}));
function getEmailHtml({ domainName, type, commentReplyInfo, contactInfo, }) {
    return `
    <!DOCTYPE html
    ...
    <head>
      ...
      <body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #FFFFFF;">
        ...
        ? `Your comment on ${commentReplyInfo.article.title} has gotten a response${commentReplyInfo.commentReply.user
            .name
                            ...
                            <div
                              ...
                              <div class="txtTinyMce-wrapper"
                                ...
                                <p dir="ltr"
                                  ...
                                  <em>${type === EmailType.CommentReply
        ...
        : `Name: ${contactInfo.inputMessage.user.name}
                                      ...
                                      \n
                                      ${contactInfo.inputMessage.message}`}</em></p>
                              </div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                            ${type === EmailType.CommentReply &&
        `<div align="left" class="button-container"
            ...
            .split(' ')
            .join('+')}&commentId=${commentReplyInfo.originalComment.id}&email=${commentReplyInfo.originalComment.user.email}"
...
exports.default = getEmailHtml;
//# sourceMappingURL=getEmailHtml.js.map