...
(function() {
   ...
   sh.exec(
      `aws cloudformation deploy --template-file ./template.yml --stack-name jwstanly-website --parameter-overrides DomainName=${BUCKET_NAME} FullDomainName=www.${BUCKET_NAME} AcmCertificateArn=${ACM_CERT_ARN}`
   );
})();
