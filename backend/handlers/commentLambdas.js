...
exports.deleteCommentReply =
  ...
  exports.upsertCommentReply =
  exports.upsertComment =
    void 0;
...
async function upsertComment(event) {
  ...
  const outputComment = Object.assign(Object.assign({}, inputComment), {
    user: outputUser,
...
async function upsertCommentReply(event) {
  ...
  if (rootCommentIndex === -1) {
    return lambdaUtils_1.default.getErrorRes(
      event,
      404,
      'No root comment found',
    );
  }
  const repliedToComment =
    ...
    const emailParams = {
      ...
      Message: {
        ...
        Body: {
          Html: {
            Charset: 'UTF-8',
            Data: lambdaUtils_1.default.getEmailHTML(
              domainName,
              articleRes.Item,
              repliedToComment,
              inputCommentReply,
  ...
  const outputCommentReply = Object.assign(
    Object.assign({}, inputCommentReply),
    {
      user: outputUser,
