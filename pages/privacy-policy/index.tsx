...
export default function PrivacyPolicy() {
  return (
    <>
      <HeadTags title="Privacy Policy - John Wright Stanly" />
      ...
      <CenteredContainer>
        ...
        <ul>
          ...
          <li>
            ...
            this Agreement) refers to John Wright Stanly's Personal Website and
            Blog.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to John Wright Stanly's Personal
            Website and Blog, accessible from{' '}
            <a href="https://www.jwstanly.com" rel="external nofollow noopener">
              https://www.jwstanly.com
            </a>
          </li>
          <li>
        ...
        <strong>
          <u>Necessary / Essential Cookies</u>
        </strong>
        ...
        <strong>
          <u>Cookies Policy / Notice Acceptance Cookies</u>
        </strong>
        ...
        <ul>
          <li>
            ...
            <a
              href="https://www.jwstanly.com/contact"
              rel="external nofollow noopener"
            >
              https://www.jwstanly.com/contact
            </a>
          </li>
        </ul>
      </CenteredContainer>
